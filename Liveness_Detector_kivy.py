...
<HomeScreen>:
    ...
    ActionBar:
        pos_hint: {'top':1}
        background_color: 0, 0.8, 0.6, 0.8
        ActionView:
            use_separator: True
            ActionButton:
                id: btn_login
...
<LoginScreen>:
    ...
    Button:
        ...
        text: 'Give Permission For Access Camera'
        on_press:
            root.start_cam()
            # root.show_hide(menu)
...
class LoginScreen(Image, Screen):
    def start_cam(self, fps=30, **kwargs):
        ...
        self.capture = cv2.VideoCapture('today_fake.webm')
